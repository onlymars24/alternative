...
class WrongsExport implements FromArray, WithColumnWidths, WithStyles
{
    ...
    public function array(): array
    {
        ...
        $tickets = [];
        $tickets[] = ['Билеты обработанные неправильно'];
