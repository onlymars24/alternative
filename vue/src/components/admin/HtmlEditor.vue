<template>
  ...
  <div style="display: flex; justify-content: space-between; margin-top: 10px;">
    <el-button type="primary" :loading="loading" @click="$emit('editStation', this.id, this.title, this.name, this.newContent, this.dispatch_point_id, this.hidden)">{{loading ? 'Загрузка' : 'Сохранить' }}</el-button>
...
export default {
  ...
  props: ['id', 'title', 'name', 'data', 'dispatch_point_id', 'hidden'],
  data() {
    return {
